 ...
 */
public class OkhttpNetworkFecther extends
    BaseNetworkFetcher<OkhttpNetworkFecther.OkHttpNetworkFetchState> {
   ...
   */
  public OkhttpNetworkFecther(OkHttpClient okHttpClient) {
