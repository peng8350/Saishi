...
public class SwipeListView extends ListView {
    ...
    */
     ...
     */
    protected void onChoiceEndedled(){
        if (swipeListViewListener != null) {
    ...
    /**
     * User is in last item of listled());
	...
	protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrtouchollY, int scrollRangeX, int scrollRangeY,
